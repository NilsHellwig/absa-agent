...
1. For each identified review, extract:
   ...
   - `review_text`: The review text content only. Do **not** include author names, date, star ratings, or category scores in this field.
...
3. If a review appears **truncated** (e.g., ends with "..."), extract the partial review text for later reconstruction.
